...
1. 完全退出魔兽世界游戏客户端；
2. 在 [Releases](https://github.com/tzdy1993/wow-hd-icons-remaster/releases) 页面下载你喜欢的方案压缩包（.zip）；
3. 解压压缩包，把解压出来的 **Interface** 文件夹直接复制到你的魔兽安装根目录下覆盖即可：
   - **正式服路径示例**：World of Warcraft\_retail_\
   - **怀旧服路径示例**：World of Warcraft\_classic_\
4. 启动游戏即可生效！
...
## ⚡ 1 秒全量极速换装系统 (Fast Switcher)

如果你在本地同时拥有多套大包，可以使用本项目内置的换装脚本：
